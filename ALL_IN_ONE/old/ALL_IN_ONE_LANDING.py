...
#                 marker.cx_cam, marker.cy_cam, marker.cz_cam, 0, "main_camera_optical", "map", listener)
...
#         )
#         rospy.sleep(0.2)
#         print((marker.cx_cam, marker.cy_cam, marker.cz_cam))
#         navigate(x=0, y=0, z=0.5, speed=0.2, frame_id="landing_target")
